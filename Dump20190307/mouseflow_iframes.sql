...
CREATE TABLE `iframes` (
  ...
  `iframeid` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `iframe` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `keyframe` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `iframes_iframeid_unique` (`iframeid`)
